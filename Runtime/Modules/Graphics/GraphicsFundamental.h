...
struct GRAPHICS_RENDER_TARGET_DESC : public GRAPHICS_SHADER_RESOURCE_TYPE_TEXTURE2D_DESC
{
	Vec4 clearColor = { 0,0,0,0 };
};

//struct GRAPHICS_DEPTH_STENCIL_BUFFER_DESC : public GRAPHICS_SHADER_RESOURCE_TYPE_TEXTURE2D_DESC
//{
