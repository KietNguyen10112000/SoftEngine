...
public:
	...
	void DrawLineSegment(const Vec3& begin, const Vec3& end, const Vec4& color = { 0,1,0,1 }, float thickness = 0.005f);
	void DrawRay(const Vec3& origin, const Vec3& direction, const Vec4& headColor = { 0,1,0,1 }, const Vec4& tailColor = { 1,1,0,1 }, float thickness = 0.01f);
	void DrawAABox(const AABox& aaBox, const Vec4& color = { 1,1,1,1 }, bool solid = false);
	void DrawCube(const Mat4& transform, const Vec4& color = { 1,1,1,1 }, bool solid = false);
	void DrawBox(const Box& box, const Vec4& color = { 1,1,1,1 }, bool solid = false);
