...
void DX12DebugGraphics::InitCubeRenderer()
{
...

    {
        ...
        m_cubeParams.Init(m_device, 1024, 64, 2, 1, constBufSizes, 0, 0, 0, &m_graphics->m_synchObject);
        m_cubeWireframeParams.Init(m_device, 1024, 64, 2, 1, constBufSizes, 0, 0, 0, &m_graphics->m_synchObject);
    }
